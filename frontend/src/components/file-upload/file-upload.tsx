...
>(function FileUploadDropzone(props, ref) {
  ...
  return (
    <ChakraFileUpload.Dropzone ref={ref} {...rest}>
      <Icon fontSize="2xl" color="sfblack">
        <LuUpload />
      </Icon>
      <ChakraFileUpload.DropzoneContent>
        <div>{label}</div>
        {description && <Text color="sfblack">{description}</Text>}
      </ChakraFileUpload.DropzoneContent>
      {children}
    ...
    return (
      <ChakraFileUpload.Item file={file} ref={ref}>
        <ChakraFileUpload.ItemPreview asChild>
          <Icon fontSize="xl" color="sfblack">
            <LuFile />
          </Icon>
        ...
        {clearable && (
          <ChakraFileUpload.ItemDeleteTrigger asChild>
            <IconButton variant="ghost" color="sfblack" size="xs">
              <LuX />
            </IconButton>
...
export const FileInput = React.forwardRef<HTMLButtonElement, FileInputProps>(
  function FileInput(props, ref) {
    ...
    const { placeholder = "Bild hochladen", ...rest } = restProps;
    return (
        ...
        >
          <ChakraFileUpload.Context>
            {({ acceptedFiles }) => {
              ...
              return <Span color="sfblack">{placeholder}</Span>;
            }}
          </ChakraFileUpload.Context>
        </Button>
