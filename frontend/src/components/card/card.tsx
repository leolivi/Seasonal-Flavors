    ...
    <div
      className={
        showDetail
          ...
          : "cursor-pointer!important mx-2 my-4 min-h-[21rem] w-80 rounded-lg bg-sfwhite-light p-3 shadow-lg first:ml-0 hover:drop-shadow-lg max-[640px]:mb-8 max-[500px]:min-h-[25rem] min-[640px]:min-h-[26rem]"
      }
    >
