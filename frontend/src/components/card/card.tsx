...
export const Card = ({
  ...
  return (
    <div
      className={`mx-2 my-4 w-auto cursor-pointer rounded-lg bg-sfwhite-light p-3 drop-shadow-lg first:ml-0`}
      onClick={onClick}
    >
      <div className="min-[640px]:min-w-70 min-[1024px]:min-w-90 aspect-square min-w-56">
