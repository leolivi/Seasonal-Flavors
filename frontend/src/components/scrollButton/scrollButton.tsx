      ...
      {isVisible && (
        <div className="group relative cursor-pointer" onClick={scrollToTop}>
          <svg
            viewBox="0 0 66 63"
            fill="none"
            className={`h-20 w-20 cursor-pointer rounded-full bg-${seasonalColor}-dark ${isVisible ? "opacity-80 hover:opacity-100" : "opacity-0"}`}
          >
            <path
            ...
            <path
              ...
              className="fill-[#FBFCF8] stroke-[#FBFCF8] stroke-[0.5] group-hover:-translate-y-2"
            />
            <path
              className="fill-[#FBFCF8] stroke-[#FBFCF8] stroke-[0.5] opacity-0 transition-opacity duration-300 group-hover:translate-y-0.5 group-hover:opacity-100"
